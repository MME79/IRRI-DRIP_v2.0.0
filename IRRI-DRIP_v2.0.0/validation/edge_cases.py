...
def main():
    ...
    for ecw, ece in [(0.5, 6.0), (2.0, 2.5), (8.0, 1.2), (20.0, 1.2)]:
        lr = K.leaching_requirement(ecw, ece)
        d = K.gross_depth(20.0, 0.90, lr)
        print(f"  ECw={ecw:5.1f}  ECe={ece:4.1f}  LR={lr*100:5.1f} %  gross depth={d:7.2f} mm")
    lr_max = K.leaching_requirement(20.0, 1.2)
